...
const FILE_PATH = '/Users/aanandiaarya/Documents/fire audit frontend/Group G Industrial.xlsx';

const SHEET_MAPPING = {
  'General': 'groupG-G-GEN.json',
  'G-1 Buildings used for low haz ': 'groupG-G-1.json',
...
function processFile(filePath, mapping, headerRowIndex) {
  ...
  for (const [sheetName, outputFilename] of Object.entries(mapping)) {
    ...
    let prefix = 'G-GEN';
    if (outputFilename.includes('G-1')) prefix = 'G-1';
    else if (outputFilename.includes('G-2')) prefix = 'G-2';
    else if (outputFilename.includes('G-3')) prefix = 'G-3';
